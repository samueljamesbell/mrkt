...
[
  ...
  { "name": "Optimisers",
    ...
    [
      ...
      {
        "alias": "Momentum Optimiser",
        "target": "sumSeries(mrkt.optimisers.momentum.performance)",
        "summary": "last",
        "renderer": "line",
        "interpolation": "basis",
        "summary_formatter": d3.format(",f")
  ...
  { "name": "Traders",
    ...
    [
      ...
      {
        "alias": "Momentum Trader Performance",
        "target": "mrkt.traders.momentum.*.performance",
        "summary": "avg",
        "renderer": "line",
        "interpolation": "basis",
        "summary_formatter": d3.format(",.2f")
